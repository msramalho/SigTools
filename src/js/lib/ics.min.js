        ...
        if (!(navigator.userAgent.indexOf("MSIE") > -1 && -1 == navigator.userAgent.indexOf("MSIE 10"))) {
            ...
            return {
                ...
                addEvent: function(t, i, o, l, u, s) {
                    ...
                    var H = ["BEGIN:VEVENT", "UID:" + n.length + "@" + e, "CLASS:PRIVATE", "DESCRIPTION:" + i, "DTSTAMP;VALUE=DATE-TIME:" + m, "DTSTART;VALUE=DATE-TIME:" + C, "DTEND;VALUE=DATE-TIME:" + j, "LOCATION:" + o, "SUMMARY;LANGUAGE=en-us:" + t, "TRANSP:TRANSPARENT", "END:VEVENT"];
