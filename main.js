...
function createModal(extractor, events, repeat) {
    ...
    for (let i = 0; i < events.length; i++) {
        ...
        <li>
            ...
            <span class="calendarLink"><a id="oneClickGoogle" title="Add this single event to your Google Calendar in One click!" ><img class="calendarIcon" src="${chrome.extension.getURL("icons/gcalendar.png")}"></a></span>
            <span class="calendarLink"><a id="oneClickOutlook" title="Add this single event to your Outlook.com Calendar in One click!" ><img class="calendarIcon" src="${chrome.extension.getURL("icons/outlook.png")}"></a></span>
        </li>`;
    }
